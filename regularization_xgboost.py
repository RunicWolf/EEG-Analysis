...
# Define parameter grid for manual search including regularization parameters
param_grid = {
...
print("\n=== Starting Manual Hyperparameter Tuning with Regularization ===")
for params in param_combinations:
    n_estimators, learning_rate, max_depth, min_child_weight, subsample, colsample_bytree, reg_alpha, reg_lambda = params
    ...
    xgb = XGBClassifier(
        ...
        reg_alpha=reg_alpha,   # Apply L1 regularization
        reg_lambda=reg_lambda  # Apply L2 regularization
    )
...
print(f"reg_alpha: {best_params[6]}, reg_lambda: {best_params[7]}")
